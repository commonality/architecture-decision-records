...
|:-------------:|:----------------------:|:----------------:|
| ![ADR Status: Proposed][label-adr-proposed-img] | [Capability ![External link][icon-octicon-link-external]](.)<hr>[Category ![External link][icon-octicon-link-external]](.) | [![TechRadar: Platforms][label-platforms-img]][tw-tech-radar-platforms-url]<hr>![Hold][label-tech-radar-platforms-hold-img] |
