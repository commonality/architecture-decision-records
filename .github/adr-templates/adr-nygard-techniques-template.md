...
|:-------------:|:----------------------:|:----------------:|
| ![ADR Status: Proposed][label-adr-proposed-img] | [Capability ![External link][icon-octicon-link-external]](.)<hr>[Category ![External link][icon-octicon-link-external]](.) | [![TechRadar: Techniques][label-techniques-img]][tw-tech-radar-techniques-url]<hr>![Hold][label-tech-radar-techniques-hold-img] |
